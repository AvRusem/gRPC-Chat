...
type AuthServiceClient interface {
	Auth(ctx context.Context, in *AuthMessage, opts ...grpc.CallOption) (*AuthResponse, error)
}
...
func (c *authServiceClient) Auth(ctx context.Context, in *AuthMessage, opts ...grpc.CallOption) (*AuthResponse, error) {
...
type AuthServiceServer interface {
	Auth(context.Context, *AuthMessage) (*AuthResponse, error)
...
func (UnimplementedAuthServiceServer) Auth(context.Context, *AuthMessage) (*AuthResponse, error) {
...
func _AuthService_Auth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Auth(ctx, req.(*AuthMessage))
	}
